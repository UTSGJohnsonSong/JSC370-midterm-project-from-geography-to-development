...
Adding the three structure variables in M3 produces the largest single jump in fit across the whole sequence. R² rises from 0.394 to 0.762. The geography coefficients also decrease a lot. The latitude coefficient falls from 0.048 to 0.022 (SE = 0.004, p < 0.001), which is about a 51% reduction relative to M1. The landlocked coefficient drops from -1.084 to -0.425 (SE = 0.153, p < 0.01). Once we account for how economies are structured, geography explains much less income variation on its own.
